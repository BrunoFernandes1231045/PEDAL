...
PEDAL.SEED_CANDIDATES = [
  { id: 'c1', name: 'Joana Ferreira', locality: 'Matosinhos', stage: 'ativo',      source: 'Website',  days: 21, initials: 'JF', email: 'joana.ferreira@email.pt', contact: '912 345 678', dob: '1985-04-12', periods: ['tarde', 'fimsem'], weekdays: ['qua', 'sab'], contactDate: '2026-04-30', since: '2026-05-08' },
  ...
  { id: 'c3', name: 'Beatriz Sousa',  locality: 'Esposende',  stage: 'onboarding', source: 'Instagram', days: 6, initials: 'BS', email: 'beatriz.sousa@email.pt', contact: '914 555 333', dob: '1995-07-21', periods: ['fimsem'], weekdays: ['sab', 'dom'], contactDate: '2026-05-18' },
  ...
  { id: 'c7', name: 'Inês Carvalho',  locality: 'Gondomar',   stage: 'espera',     source: 'Instagram', days: 15, initials: 'IC', email: 'ines.carvalho@email.pt', contact: '918 333 444', dob: '1982-06-19', periods: ['fimsem'], weekdays: ['sab', 'dom'], contactDate: '2026-05-09' },
  ...
  { id: 'c10', name: 'Pedro Bastos',  locality: 'Matosinhos', stage: 'ativo',      source: 'Passa-palavra', days: 64, initials: 'PB', email: 'pedro.bastos@email.pt', contact: '911 999 000', dob: '1965-08-14', periods: ['fimsem'], weekdays: ['sab'], contactDate: '2026-03-20', since: '2026-04-02' },
